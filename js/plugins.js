...
{"name":"========================","status":true,"description":"","parameters":{}},
{"name":"QInput","status":true,"description":"<QInput>\r\nAdds additional keys to Input class, and allows remapping keys.","parameters":{"Threshold":"0.5","========":"","Ok":"#enter, #space, $A","Escape / Cancel":"#esc, $B","Menu":"#esc, $Y","Shift":"#shift, $X","Control":"#ctrl","Tab":"#tab","Pageup":"#q, $L1","Pagedown":"#w, $R1","Left":"#left, $LEFT","Right":"#right, $RIGHT","Up":"#up, $UP","Down":"#down, $DOWN","Debug":"#f9, $SELECT","===========":"","FPS":"f2","Streched":"f3","FullScreen":"f4","Restart":"f5","Console":"f8"}},
